...
<section>
	<div class="container">
		<div class="textleft">
			<form method="post" name="cal" id="cal" action="./calupdateaf.do">
				<fieldset>
					<table class="horizontal-list">
							...
							<td>
								<select name="code" id="code">
									<c:forEach var="food" items="${foods}" varStatus="vs">
										<option value="${food.code}" <c:if test="${food.code eq cal.code}">selected</c:if>>${food.name}</option>
									</c:forEach>
								</select>
							</td>
						</tr>
						<tr>
							...
							<td><input type="number" name="quantity" id="quantity" min="0" max="999" step="1" value="${cal.quantity}" width="200px"></td>
						</tr>
						<tr>
							<th>제목<em class="fc06">*</em></th>
							<td><input type="text" name="title" id="title" value="${cal.title}"></td>
						</tr>
						<tr>
							<th>내용<em class="fc06">*</em></th>
							<td><textarea type="text" name="content" id="content" cols="100%" rows="20">${cal.content}</textarea></td>
						</tr>
						<tr>
							<th>날짜<em class="fc06">*</em></th>
							<td><input type="date" name="wdate" id="wdate" value="${cal.wdate}"></td>
						</tr>
						<tr>
