...
<section class="portfolio text-white text-center" id="portfolio">
	<div class="container">
		<form class="login100-form validate-form" action="./searchpass.do" method="post" id='_fo1'>
				...
				<div class="wrap-input100 validate-input m-b-25"
					data-validate="Enter name" style="width: 500px; margin: auto">
					<input class="form-control" type="text" name="name"
						placeholder="name" style="margin-bottom: 20px;"> <span
						class="focus-input100"></span>
				</div>
