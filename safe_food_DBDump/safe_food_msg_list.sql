...
CREATE TABLE `msg_list` (
  ...
  `send_email` varchar(45) NOT NULL,
...
INSERT INTO `msg_list` VALUES (1,'root@root.com','root@root.com','12312312','2019-05-12'),(2,'yls@gmail.com','root@root.com','왜 안되냐','2019-05-12'),(3,'yls@gmail.com','root@root.com','좀 되라 제발','2019-05-12');
...
-- Dump completed on 2019-07-05 23:24:59
